...
namespace WPF_VM
{
    public sealed class FlowEditorViewModel : ViewModelBase
    {
        ...
        public ObservableCollection<FlowNodeViewModel> Nodes { get; private set; }

        public ObservableCollection<FlowConnectionViewModel> Connections { get; private set; }

        public FlowDraftConnectionViewModel DraftConnection { get; private set; }
        ...
        private sealed class ActiveConnectionDrag
        {
            ...
            public Guid FixedPortId { get; private set; }

            public FlowPortKind ExpectedPortKind { get; private set; }

            public bool IsStartDynamic { get; private set; }
    ...
    public sealed class FlowPortViewModel
    {
        ...
        public FlowPortKind Kind { get; private set; }
