...
namespace VmFunModule
{
    ...
    public static class ModuleCatalog
    {
        ...
        public static ObservableCollection<ToolCategoryViewModel> CreateCategories()
        {
            return new ObservableCollection<ToolCategoryViewModel>(
                new[]
                {
                    ...
                    {
                        new ToolItemViewModel("图像源", "\uE91B", "图像源支持相机和本地图片。", FlowNodeKind.Process),
                        new ToolItemViewModel("多图采集", "\uE8B9", "组合多路图像输入。", FlowNodeKind.Process),
        ...
        public static IList<HistoryRecordViewModel> CreateSeedHistory()
        {
            ...
            {
                new HistoryRecordViewModel { Sequence = 1, Time = "10:25:12", Module = "开始 已初始化" },
                new HistoryRecordViewModel { Sequence = 2, Time = "10:25:12", Module = "图像源 当前来源：相机" },
                new HistoryRecordViewModel { Sequence = 3, Time = "10:25:12", Module = "模板匹配 定位成功，角度偏差 0.03°" },
                new HistoryRecordViewModel { Sequence = 4, Time = "10:25:12", Module = "距离测量 输出 12.486 mm" }
            };
        }
    }
}
